...
export declare module Telegram {
    module Bot {
        ...
        class api {
            ...
            static sendPhoto: (token: string, chat_id: number, photo: string, caption?: string, parse_mode?: string, disable_notification?: boolean, reply_to_message_id?: number) => Promise<Response<Message>>;
            ...
            static sendVoice(token: string, chat_id: number, voice: string, caption?: string, parse_mode?: string, duration?: number, disable_notification?: boolean, reply_to_message_id?: number, reply_markup?: InlineKeyboardMarkup | ReplyKeyboardMarkup | ReplyKeyboardRemove | ForceReply): Promise<Response<Message>>;
            static sendVideoNote(token: string, chat_id: number, video_note: string, duration?: number, length?: number, thumb?: string, disable_notification?: boolean, reply_to_message_id?: number, reply_markup?: InlineKeyboardMarkup | ReplyKeyboardMarkup | ReplyKeyboardRemove | ForceReply): Promise<Response<Message>>;
            static sendMediaGroup(token: string, chat_id: number, media: Array<any>, disable_notification?: boolean, reply_to_message_id?: number): Promise<Response<Message>>;
            static sendLocation(token: string, chat_id: number, latitude: number, longitude: number, live_period?: number, disable_notification?: boolean, reply_to_message_id?: number, reply_markup?: InlineKeyboardMarkup | ReplyKeyboardMarkup | ReplyKeyboardRemove | ForceReply): Promise<Response<Message>>;
            ...
            static sendDice(token: string, chat_id: number, emoji?: string, disable_notification?: boolean, reply_to_message_id?: number, reply_markup?: InlineKeyboardMarkup | ReplyKeyboardMarkup | ReplyKeyboardRemove | ForceReply): Promise<Response<Message>>;
            static sendSticker(token: string, chat_id: number | string, sticker: string, disable_notification?: boolean, reply_to_message_id?: number, allow_sending_without_reply?: boolean, reply_markup?: any): Promise<Response<Message>>;
