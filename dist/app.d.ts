...
export declare module Telegram {
    module Bot {
        ...
        class api {
            ...
            static editMessageText(token: string, chat_id: number, message_id: string, inline_message_id: string, text: string, parse_mode?: string, disable_web_page_preview?: boolean, reply_markup?: InlineKeyboardMarkup | ReplyKeyboardMarkup | ReplyKeyboardRemove | ForceReply): Promise<Response<unknown>>;
